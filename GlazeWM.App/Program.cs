...
internal static class Program
{
  ...
  public static async Task<int> Main(string[] args)
  {
    ...
    WindowsApiService.AttachConsoleToParentProcess();

    using var _ = new Mutex(false, "Global\\" + AppGuid, out var isSingleInstance);

    var parsedArgs = Parser.Default.ParseArguments<WmStartupOptions, WatcherStartupOptions, InvokeCommandMessage, SubscribeMessage, GetMonitorsMessage, GetWorkspacesMessage, GetWindowsMessage>(args);
