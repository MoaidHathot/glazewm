...
public record MeteoWeatherResult
{
  ...
  public required MeteoCurrentWeatherResult CurrentWeather { get; set; }

  [JsonPropertyName("daily")]
  public required MeteoDailyResult Daily { get; set; }
}

public record MeteoDailyResult
{
  [JsonPropertyName("sunset")]
  public required List<DateTime> Sunset { get; set; }

  [JsonPropertyName("sunrise")]
  public required List<DateTime> Sunrise { get; set; }
}
