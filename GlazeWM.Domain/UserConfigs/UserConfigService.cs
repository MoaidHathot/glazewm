...
public class UserConfigService
{
  ...
  /// </summary>
  public required UserConfig UserConfig { private get; set; }
  ...
  {
    return WorkspaceConfigs.Find((workspaceConfig) => workspaceConfig.Name == workspaceName);
  }

  public BindingMode GetBindingModeByName(string bindingModeName)
  {
    return BindingModes.Find((bindingMode) => bindingMode.Name == bindingModeName);
  }
