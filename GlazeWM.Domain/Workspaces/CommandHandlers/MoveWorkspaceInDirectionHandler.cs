  ...
  ICommandHandler<MoveWorkspaceInDirectionCommand>
{
  ...
  private void ActivateWorkspaceOnMonitor(Monitor monitor)
  {
    ...
    var inactiveWorkspaceConfig = _workspaceService.GetWorkspaceConfigToActivate(monitor) ?? throw new FatalUserException("At least 1 workspace is required per monitor.");
